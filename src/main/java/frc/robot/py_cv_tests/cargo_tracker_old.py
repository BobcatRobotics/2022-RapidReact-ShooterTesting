...
while True:
    ...
    # Get circles
    red_circles = cv.HoughCircles(red_mask, cv.HOUGH_GRADIENT, dp=1.5, minDist=300, param1=100, param2=30, minRadius=10, maxRadius=400)
    blue_circles = cv.HoughCircles(blue_mask, cv.HOUGH_GRADIENT, dp=1.5, minDist=300, param1=100, param2=30, minRadius=10, maxRadius=400)
