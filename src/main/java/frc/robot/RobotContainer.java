...
public class RobotContainer {
  ...
  public static TrajectoryConfig getConfig() {
    ...
    var autoVoltageConstraint = new DifferentialDriveVoltageConstraint(
        new SimpleMotorFeedforward(ksVolts, kvVoltSecondsPerMeter, kaVoltSecondsSquaredPerMeter), kDriveKinematics, 5);
  ...
  public Trajectory getCurvyTrajectory(TrajectoryConfig config) {
  ...
  public String[] deadAutoIDs = {"dA_2B", "dA_3B_right", "getRamsete"};
  ...
  //   Command drivePartiallyToThirdBall = new FV_DriveTime(drivetrain, 4, 4, 0.8);
  //   Command alignToThirdBall = new alignToNearestBall(drivetrain);
  //   Command alignToThirdBall2 = new alignToNearestBall(drivetrain);
  ...
  //   Command alignToLastBalls2 = new alignToNearestBall(drivetrain);
  ...
  public Command getRamseteAutoCommand() {
    ...
    var autoVoltageConstraint =
        new DifferentialDriveVoltageConstraint(
            ...
            3.5); // max voltage is 3 just to make sure testing yields slow motion along path
    ...
    Trajectory straightLineTrajectory = getCurvyTrajectory(config);
    ...
    //     RouteFinderConstants.kDriveKinematics,
    //     drivetrain::setVelocityMetersPerSecond,
    //     drivetrain);
    // ^WORKED WORKED WORKED
